        ...
        <form class="ui form" method="POST" action="product" enctype="multipart/form-data">
            ...
            <div class="fields inline">
               <div class="three wide field"><label>名称</label></div>
                <div class="eleven wide field"><input name="product.name" type="text" required/></div>
            </div>
            <div class="fields inline">
                <div class="three wide field"><label>类型</label></div>
                <div class="eleven wide field"><select name="product.type">
            ...
            <div class="fields inline">
                ...
                <div class="eleven wide field"><input name="product.price" type="text" required/></div>
            </div>
            <div class="fields inline">
                <div class="three wide field"><label>折扣</label></div>
                <div class="eleven wide field"><input name="product.discount" type="text" value="1.0"/></div>
            </div>
            <div class="fields inline">
                <div class="three wide field"><label>商品描述</label></div>
                <div class="eleven wide field"><textarea name="product.description" required></textarea></div>
            </div>
            <button class="ui button green inverted" type="submit">新增</button>
        </form>
    </div>
</div>
